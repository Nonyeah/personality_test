...
export default function Page6({ page, setpage }: UserAnswers) {
	{
		...
		return (
			<div className="intro-questions">
				<h1>Workplace-Oriented Questions</h1>
			
				<div className="questions">
					<p ref={question1Ref} className="question">
						I prefer making decisions quickly rather than spending a long time analyzing options
					</p>
					<div className="answers">{question1}</div>
					<p ref={question2Ref} className="question">
						I enjoy working independently without close supervision
					</p>
					...
					<p ref={question4Ref} className="question">
						I am comfortable taking responsibility for difficult decisions
					</p>
