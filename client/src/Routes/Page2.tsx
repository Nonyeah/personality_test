...
export default function Page2({ page, setpage }: UserAnswers) {
		...
		<div className="intro-questions">
			...
			<div className="questions">
				<p ref={question1Ref} className="question">
					I make detailed plans before starting important tasks
				</p>
				...
				<p ref={question3Ref} className="question">
					I complete tasks on time, even when they are difficult
				</p>
				...
				<p ref={question5Ref} className="question">
					I prefer structure and routine in my daily life
				</p>
