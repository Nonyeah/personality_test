...
export default function Page3({ page, setpage }: UserAnswers) {
	...
	return (
		<div className="intro-questions">
			<h1>Emotional Stability (Neuroticism reversed)</h1>
			...
			<div className="questions">
				...
				<p ref={question3Ref} className="question">
					I rarely worry about things I cannot control
				</p>
				<div className="answers">{question3}</div>
				<p ref={question4Ref} className="question">
					I stay composed during conflicts
				</p>
